...
public interface Patient extends PrimaryEntity
{
    ...
    /**
     * Update patient data according to the specified {@code policy}, using the provided json object (in the format
     ...
     */
    void updateFromJSON(JSONObject json, PatientWritePolicy policy);
}
